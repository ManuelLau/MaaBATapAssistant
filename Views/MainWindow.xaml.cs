...
public partial class MainWindow
{
    public MainWindow()
    {
        ...
        Utility.CustomDebugWriteLine($"启动程序。当前程序版本 - {Assembly.GetExecutingAssembly().GetName().Version}");
#if DEBUG
        CheckVersionIsSame();
#endif
    }
    ...
    {
        Application.Current.Dispatcher.Invoke(MainViewModel.Instance.LogDataList.Clear);
    }
